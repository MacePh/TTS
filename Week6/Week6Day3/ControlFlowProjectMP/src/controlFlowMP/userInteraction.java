...
//	Questions for the survey:
		String q0 = "What is the age of your favorite pet?";//
		String q1 = "What is your lucky number?";
		String q2 = "Favorite quarterback jersey number? If none then enter 0";
		String q3 = "What is two-digit model year of their car?";
		String q4 = "Enter a random number between 1 and 50.";
		String q5 = "Do you have a red car? Yes or No?";
		String q6 = "What is the name of your favorite pet?";
		String q7 = "What is the first name of the their favorite actor or actress?";
...
//	* Favorite QB number + age of pet + lucky number.
		...
		System.out.println("Your lucky numbers are: " + lN1 + "," + lN2 + "," + lN3 + "," + lN4 + "," + lN5
				+ " Magic Ball: " + mB);
